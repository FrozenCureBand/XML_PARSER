...
public class Parser implements ParserConstants {static int i;
  ...
  static final public void PROLOGO() throws ParseException {
    jj_consume_token(LEFT_TAG);
    VERSION();
    ENCODING();
    ...
    jj_consume_token(TAG_PROLOG);
    jj_consume_token(RIGHT_TAG);
  }
 ...
 Token t;
  ...
  static final public void ENCODING() throws ParseException {
 Token t;
    jj_consume_token(21);
    jj_consume_token(20);
  ...
  static final public void STANDALONE() throws ParseException {
 Token t;
    jj_consume_token(22);
    jj_consume_token(20);
